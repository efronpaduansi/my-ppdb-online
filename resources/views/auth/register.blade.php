              ...
              <div class="card-body p-5">
                ...
                <form action="{{ route('auth.register') }}" method="POST" class="needs-validation" novalidate>
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <input type="text" id="fname" name="fname" class="form-control form-control-lg @error('fname') is-invalid @enderror" value="{{ old('fname') }}" autofocus placeholder="Masukan nama lengkap" />
                    @error('fname')
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <input type="email" id="email" name="email" class="form-control form-control-lg @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="Masukan email" />
                    @error('email')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                      </span>
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <input type="password" id="passConf" name="passConf" class="form-control form-control-lg @error('passConf') is-invalid @enderror" placeholder="Konfirmasi password"/>
                    @error('passConf')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
