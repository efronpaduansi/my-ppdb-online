    ...
    <div class="col-lg-3 col-md-4">
        <div class="ibox">
            <div class="ibox-body text-center">
                <div class="m-t-20">
                    {{-- <img class="border border-secondary" src="{{ asset('uploads/berkas/foto'. $berkas->foto) }}" /> --}}
                </div>
                <h5 class="font-strong m-b-10 m-t-10">{{ $siswa->nama_lengkap }}</h5>
                <div class="m-b-20 text-muted">NISN. {{ $siswa->nisn }}</div>
            </div>
        </div>
    </div>
                                ...
                                <div class="m-b-20">
                                    <form action="">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $siswa->nama_lengkap }}" class="form-control" readonly>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ $siswa->tempat_lahir }}, {{ $siswa->tanggal_lahir }}" class="form-control" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Jenis Kelamin</label>
                                            <input type="text" value="{{ $siswa->jenis_kelamin }}" class="form-control" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="">Agama</label>
                                            <input type="text" value="{{ $siswa->agama }}" class="form-control" readonly>
                                        </div>
                                    </form>
                                </div>
                            </div>
