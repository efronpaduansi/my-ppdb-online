                ...
                <div class="row">
                    <div class="col-lg-2 col-md-2 col-sm-3">
                        <div class="logo-area">
                            ...
                            <a href="{{ route('ppdb.index') }}" style="font-size: 20px; color:white;">YAYASAN GTC</a>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-9">
                        <nav id="desktop-nav">
                            <ul>
                                <li><a href="{{ route('ppdb.program.studi') }}"
                                        class="{{ request()->is('program-studi') ? 'active' : '' }}">Jurusan</a></li>
                                <li><a href="{{ route('ppdb.alur.pendaftaran') }}"
                                        class="{{ request()->is('alur-pendaftaran') ? 'active' : '' }}">Alur
                                        Pendaftaran</a></li>
                                <li><a href="{{ route('ppdb.pengumuman') }}"
                ...
                <div class="col-md-12">
                    <div class="mobile-menu">
                        <nav id="dropdown">
                            <ul>
                                <li>
                                    <a href="{{ route('ppdb.program.studi') }}"
                                        class="{{ request()->is('program-studi') ? 'active' : '' }}">Jurusan</a>
                                </li>
                                <li>
                                    <a href="{{ route('ppdb.alur.pendaftaran') }}"
                                        class="{{ request()->is('alur-pendaftaran') ? 'active' : '' }}">Alur
                                        Pendaftaran</a>
                                </li>
                                <li>
                                    <a href="{{ route('ppdb.pengumuman') }}"
                                        class="{{ request()->is('pengumuman') ? 'active' : '' }}">Pengumuman</a>
                                    <div class="col-lg-4 col-md-4 hidden-sm">
                                        <div class="apply-btn-area">
                                            @auth
                                                @if (Auth::user()->role == 'admin')
