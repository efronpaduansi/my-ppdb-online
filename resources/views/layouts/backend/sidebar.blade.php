<nav class="page-sidebar" id="sidebar">
    <div id="sidebar-collapse">
        ...
        <ul class="side-menu metismenu">
            ...
            <li class="{{ (request()->is('admin/jurusan')) || (request()->is('admin/edit-jurusan/')) || (request()->is('admin/periode')) || (request()->is('admin/periode/create')) ? 'active' : '' }}">
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="{{ route('admin.jurusan.index') }}" class="{{ (request()->is('admin/jurusan')) ? 'active' : '' }}">Jurusan</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.periode.index') }}" class="{{ (request()->is('admin/periode')) || (request()->is('admin/periode/create')) ? 'active' : '' }}">Periode</a>
                    </li>
                </ul>
            </li>
            <li class="{{ (request()->is('admin/data-pendaftaran')) || (request()->is('admin/detail-pendaftaran')) ? 'active' : '' }}">
            ...
            <li class="{{ (request()->is('admin/staff')) || (request()->is('informasi')) || (request()->is('new-informasi')) || (request()->is('admin/profile')) || (request()->is('admin/web-setting')) ? 'active' : '' }}">
                ...
                <ul class="nav-2-level collapse">
                    <li>
                        <a href="{{ route('admin.staff.index') }}" class="{{ (request()->is('admin/staff')) ? 'active' : '' }}">Staff</a>
                    </li>
                    <li>
                        <a href="{{ route('informasi.index') }}"  class="{{ (request()->is('informasi')) || (request()->is('new-informasi')) ? 'active' : '' }}">Informasi</a>
                    </li>
                    <li>
                        <a href="{{ route('admin.profile.index') }}"  class="{{ (request()->is('admin/profile')) ? 'active' : '' }}">Profile</a>
                    </li>
                    <li>
                        <a href="{{ route('website.setting.index') }}"  class="{{ (request()->is('admin/web-setting')) ? 'active' : '' }}">Website</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="{{ (request()->is('guest/pendaftaran')) || (request()->is('guest/pendaftaran/data-orangtua')) || (request()->is('guest/pendaftaran/data-sekolah')) || (request()->is('guest/pendaftaran/berkas')) ? 'active' : '' }}">
